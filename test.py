...
#define the models and what each operator relates to 
...
# plot a figure for the model
plt.figure(figsize=(15, 15))
# generate data for specific player, input the data you collect from the player in 20 matches
model.plot(
    variables=variables,
    rules=rules,
    win=10,
